...
export const LOVE: GameEvent[] = [
  ...
  { id: 'love.proposal', title: 'Una propuesta', tags: ['love'], weight: 12,
    ...
    choices: [
      ...
      { label: 'Pedir tiempo', outcomes: [
        { weight: 1, text: 'Pediste tiempo. {partner} lo tomó a mal.', effects: [fx.close('partner', -15), fx.hap(-3)] },
      ] },
    ] },
  { id: 'love.partner_cheats', title: 'Infidelidad', tags: ['love'], weight: 7,
    ...
    choices: [
      { label: 'Perdonar', outcomes: [
        { weight: 5, text: 'Lo/a perdonaste. Ya nada es lo mismo.', effects: [fx.close('partner', -20), fx.hap(-6)] },
        { weight: 5, text: 'Lo/a perdonaste y se lo tomó en serio. Quizás salga algo bueno.', effects: [fx.close('partner', 5), fx.hap(-2)] },
      ] },
      ...
      { label: 'Vengarte con otra persona', outcomes: [
        { weight: 1, text: 'Ojo por ojo. Ahora los dos quedaron mal parados.', effects: [fx.close('partner', -30), fx.hap(-2)] },
      ] },
    ] },
  { id: 'love.temptation', title: 'Tentación', tags: ['love'], weight: 8,
    ...
    choices: [
      { label: 'Ceder', outcomes: [
        { weight: 5, text: 'Cediste. Lo pasaste genial y te sentís mal.', effects: [fx.hap(2)] },
        { weight: 5, text: '{partner} se enteró. Se armó un escándalo.', effects: [fx.close('partner', -40), fx.hap(-8)] },
      ] },
      { label: 'Rechazar', outcomes: [{ weight: 1, text: 'Dijiste que no. Te sentiste un santo/a por dos minutos.', effects: [fx.hap(1), fx.close('partner', 2)] }] },
    ] },
  ...
  { id: 'love.ex_returns', title: 'Vuelve tu ex', tags: ['love'], weight: 8,
    ...
    choices: [
      { label: 'Responder', outcomes: [
        { weight: 4, text: 'Hablaron por horas. Hay algo todavía.', effects: [fx.becomes('ex', 'partner'), fx.hap(5)] },
        { weight: 6, text: 'Terminó en un desastre emocional. Te arrepentís.', effects: [fx.hap(-5)] },
      ] },
      { label: 'Bloquearlo/a', outcomes: [{ weight: 1, text: 'Lo/a bloqueaste. Ahora dormís mejor.', effects: [fx.hap(2), fx.close('ex', -50)] }] },
    ] },
  ...
  { id: 'love.anniversary', title: 'Aniversario', tags: ['love'], weight: 10,
    ...
    effects: [fx.close('partner', 6), fx.hap(4), fx.money(-200)] },
];
