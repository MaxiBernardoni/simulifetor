...
import {
  ...
  Crown, Dices, Download, Droplet, Dumbbell, Eye, Flag,
  Flame, Flower2, Gamepad2, Gavel, Gem, Ghost, Gift,
  Globe, GraduationCap, Hammer, Handshake, Heart, HeartCrack, HeartHandshake,
  HeartPulse, Hourglass, House, IdCard, Landmark, LayoutGrid, Library,
  Lightbulb, Link, Lock, Medal, Megaphone, Menu, MessageCircle,
