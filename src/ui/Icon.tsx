...
import {
  ...
  HeartHandshake, HeartPulse, Hourglass, House, IdCard, KeyRound, Landmark,
  LayoutGrid, Library, Lightbulb, Link, Lock, Medal, Megaphone,
  Menu, MessageCircle, Moon, Music, Package, Palette, PartyPopper,
  PawPrint, PenTool, PiggyBank, Pill, Plane, Plus, RefreshCcw,
