...
- Las acciones de la ficha van en **subpestañas**: primero se ven las categorías como tarjetas (con la cantidad de acciones disponibles) y al tocar una se muestran solo sus acciones, con un botón "Volver a las categorías". Si la persona es adulta y el amor sigue bloqueado por falta de amistad, un aviso dice cuánto falta para los 50.
