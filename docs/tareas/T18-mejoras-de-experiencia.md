...
Ideas aprobadas por Max el 21/09/2026. Se pueden hacer por separado, en este orden.
...
7. **Origen de los cambios:** tocar un chip (−4, −$4.869) muestra qué lo causó ("Felicidad −4: Estalla la burbuja −3, Gripe −1"). Requiere guardar en `lastDelta` el título del evento de cada cambio.
